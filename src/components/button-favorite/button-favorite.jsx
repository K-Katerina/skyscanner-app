...
export const ButtonFavorite = ({item}) => {
    ...
    return (
        <button className="btn btn-link p-0" style={{'width':'min-content'}} onClick={() => handleFavoriteChange(item.QuoteId + selectedDate)} type="button">
            <svg width="23" height="20" viewBox="0 0 23 20" fill={favoriteIds.has(item.QuoteId + selectedDate) ? '#F04393' : 'none'} xmlns="http://www.w3.org/2000/svg">
